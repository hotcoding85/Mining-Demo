import { getDispatch, postDispatch, putDispatch, deleteDispatch } from "Helpers/api_dispatch_helper";
...
export const updateDispatch = (id: string, Dispatch: any) => async (dispatch: any) => {
    try {
        let response: any;
