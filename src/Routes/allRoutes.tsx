...
const authProtectedRoutes = [
  ...
  { path: "/geofences", exact: true, component: <Geofences socket={socket} /> },
  {
    ...
    exact: true,
    component: <DailyProductionDashboard />,
  },
  {
  ...
  {
    path: "/trucking-performance",
    exact: true,
    component: <TruckingPerformance />,
  },
  ...
  {
    path: "/maintenance-fuel-status",
    exact: true,
    component: <FuelStatusDashboard />,
  },
  {
  ...
  {
    path: "/fleet-optimisation",
    exact: true,
    component: <FleetOptimisation />,
  },
  ...
  {
    path: "/haul-road-intelligence",
    exact: true,
    component: <HaulRoadIntelligence />,
  },
