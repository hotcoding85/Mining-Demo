...
export const data: {
  ...
  nodes: [
    { name: "Kohle", origin: "source", type: "primary" },
    { name: "Öl", origin: "source", type: "primary" },
    { name: "Gas", origin: "source", type: "primary" },
    { name: "Sonstige Biogene fest", origin: "wastedestination", type: "primary" },
