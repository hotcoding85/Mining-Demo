...
const HaulRouteItem : React.FC<HaulRouteItemProps> = ({
    dumpLocation
}) => {
    ...
    return (
        <div ref={drag} style={{ opacity: isDragging ? 0.5 : 1 }} className="haul-route-item">
            <img src={dumpLocation.locationImg} alt="north" />
            <p className="haul-route-chips">{dumpLocation.locationName}</p>
        </div>
    )
}
