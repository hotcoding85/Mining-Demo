...
const MessageBoard : React.FC = () => {
    ...
    const [allMessages, setAllMessages] = useState<MessageData[]>(sampleAllMessages);
    const [newMessages, setNewMessages] = useState<MessageData[]>(sampleNewMessages);
        ...
        <React.Fragment>
            <div>
                <div className="d-flex flex-row justify-content-between">
                    ...
                    <div className="show-more-btn" onClick={onViewHistory}>{!isViewHistory ? 'View History' : 'New Messages'}</div>
                </div>
