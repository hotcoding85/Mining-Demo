  ...
  const columns: TableColumn[] = useMemo(
    () => [
      ...
      },
      {
        ...
        cell: (cellProps: any) => {
          return (
            <Input type='number' e onChange={onFieldChange} value={cellProps.row.original.availablePer}> </Input>
          );
        }
      },
      {
        ...
        cell: (cellProps: any) => {
          return (
            <Input type='number' onChange={onFieldChange} value={cellProps.row.original.availableHrs}> </Input>
          );
        }
      },
      {
        ...
        cell: (cellProps: any) => {
          return (
            <Input type='number' onChange={onFieldChange} value={cellProps.row.original.standbyHrs}> </Input>
          );
        }
      },
      {
        ...
        cell: (cellProps: any) => {
          return (
            <Input type='number' onChange={onFieldChange} value={cellProps.row.original.utilizeHrs}> </Input>
          );
        }
      },
      {
        ...
        cell: (cellProps: any) => {
          return (
            <Input type='number' onChange={onFieldChange} value={cellProps.row.original.loads}> </Input>
          );
        }
      },
      {
        ...
        cell: (cellProps: any) => {
          return (
            <Input type='number' onChange={onFieldChange} value={cellProps.row.original.tonnes}> </Input>
          );
        }
      },
      {
