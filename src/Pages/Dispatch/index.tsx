                                    ...
                                    <Row>
                                        <Col lg="10">
                                            <div className="schedule-container">
                                                <ScheduleComponent ref={scheduleObj} cssClass='schedule-drag-drop' width='100%' height='100%'
                                                    ...
                                                    showTimeIndicator={true} showQuickInfo={true}
                                                    group={{ enableCompactView: false, resources: ['FleetTypes', 'Diggers'] }}
                                                ...
                                                >
                                                    <ResourcesDirective>
                                                        ...
                                                        <ResourceDirective field='FleetId' title='Diggers' name='Diggers' allowMultiple={true} dataSource={getResourceData()} textField='Text' idField='Id' groupIDField="GroupId" colorField='Color' />
                                                    </ResourcesDirective>
                                                    <ViewsDirective>
                                        ...
                                        <Col lg="2">
                                            <Card>
                                                ...
                                                <CardBody>
                                                    <div className="treeview-container" style={{ width: '100%', height: '100%' }}>
                                                        <div className="title-container">
