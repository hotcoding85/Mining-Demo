...
// Get ShiftRoster
export const getShiftRoster = (roster: any) => api.get(`${url.SHIFT_ROSTER}/${roster}`, {});

// Create ShiftRoster
export const postShiftRoster = (ShiftRoster: any) => api.create(url.SHIFT_ROSTER, ShiftRoster);
